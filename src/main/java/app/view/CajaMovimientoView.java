...
public class CajaMovimientoView extends JPanel {
    ...
    private JPanel createRegistroPanel() {
        ...
        pnlRegistro.add(new JLabel("Tipo:"), gbc);
        gbc.gridx = 1;
        gbc.gridy = row++;
        gbc.weightx = 1.0;
        pnlRegistro.add(cmbTipo, gbc);

        // Fila 2: Subtipo
        gbc.gridx = 0;
        gbc.gridy = row;
        gbc.anchor = GridBagConstraints.WEST;
        pnlRegistro.add(new JLabel("Subtipo (Ej. Pago, Proveedor):"), gbc);
        gbc.gridx = 1;
        gbc.gridy = row++;
        gbc.weightx = 1.0;
        pnlRegistro.add(txtSubtipo, gbc);

        // Fila 3: Monto
        gbc.gridx = 0;
        gbc.gridy = row;
        gbc.anchor = GridBagConstraints.WEST;
        pnlRegistro.add(new JLabel("Monto:"), gbc);
        gbc.gridx = 1;
        gbc.gridy = row++;
        gbc.weightx = 1.0;
        pnlRegistro.add(txtMonto, gbc);

        // Fila 4: Descripción
        gbc.gridx = 0;
        gbc.gridy = row;
        gbc.anchor = GridBagConstraints.NORTHWEST;
        pnlRegistro.add(new JLabel("Descripción:"), gbc);
        gbc.gridx = 1;
        gbc.gridy = row++;
        gbc.weightx = 1.0;
        gbc.weighty = 1.0;
        pnlRegistro.add(scrollDescripcion, gbc);
        ...
        pnlRegistro.add(btnRegistrar, gbc);
