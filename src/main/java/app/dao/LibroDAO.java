...
public class LibroDAO extends BaseDAO {
    ...
    // Buscar libros por título (para clientes)
    public List<LibroConAutor> buscarPorTitulo(String titulo) {
        List<LibroConAutor> lista = new ArrayList<>();
        ...
        String sql = """
            ...
            JOIN Autor a ON a.id = l.idAutor
            JOIN Categoria c ON c.id = l.idCategoria
            WHERE l.titulo LIKE ? AND l.estado = 1
        ...
        try (Connection con = Conexion.getConnection();
            ...
            // Auditoría
            auditar("Catalogo-Libro", "BuscarLibroPorTitulo",
                    "Consulta por título: " + titulo);
