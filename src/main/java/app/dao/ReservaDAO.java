...
public class ReservaDAO {
    ...
    public boolean actualizar(Reserva r) throws SQLException {
        ...
        try (Connection con = Conexion.getConnection();
            ...
            if (actualizado) JOptionPane.showMessageDialog(null, "Reserva actualizada correctamente.");
            return actualizado;
        }
    }
    ...
    public boolean eliminar(int id) throws SQLException {
        ...
        try (Connection con = Conexion.getConnection();
            ...
            if (desactivado) JOptionPane.showMessageDialog(null, "Reserva desactivada correctamente.");
            return desactivado;
        }
    }
